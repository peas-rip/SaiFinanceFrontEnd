...
const formSchema = z.object({
  ...
  primaryContactNumber: z.string().min(10, "Primary contact number is required"),
  ...
  referralName1: z.string().min(2, "Referral name is required"),
  referralPhone1: z.string().min(10, "Referral phone number is required"),

  referralName2: z.string().min(2, "Referral name is required"),
  referralPhone2: z.string().min(10, "Referral phone number is required"),
});
      ...
      <div className="container max-w-3xl mx-auto py-12 px-4">
        ...
        <Card className="shadow-xl border-2">
          <CardHeader className="text-center bg-gradient-to-br from-primary/5 to-accent/5">
            ...
            <CardTitle className="text-3xl font-bold">Loan Application Form</CardTitle>
            <CardDescription className="text-base">Fill in your details</CardDescription>
          </CardHeader>
